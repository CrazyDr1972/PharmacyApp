...
"SET FPA = T2.AP_FP_ID " &
    ...
    Private Function GetXondrSelectedDrug(ByVal ApCode As String) As Decimal
        Dim SQLstring As String = "SELECT AP_TIMH_XON " &
                          "FROM APOTIKH  " &
    ...
    Private Sub ApplyReadOnlyOnExchangeGrids()
        For Each dgv As DataGridView In New DataGridView() {dgvGivenTo, dgvTakenFrom}
            dgv.ReadOnly = True                                   ' καμία επεξεργασία από χρήστη
            dgv.EditMode = DataGridViewEditMode.EditProgrammatically ' ούτε με F2/διπλό-κλικ
